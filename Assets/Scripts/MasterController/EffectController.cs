...
public class EffectController : MonoBehaviour
{
    ...
    public void doShakeCamera()
    {
        if (shakeTime > 0)
        {
            ...
            {
                case 1:
                    Master.Gameplay.myCamera.transform.localPosition = Random.insideUnitSphere * shakeAmount;
                    break;
                case 2:
                    if (Master.UIGameplay != null)
                    {
                        Master.UIGameplay.myCamera.transform.localPosition = Random.insideUnitSphere * shakeAmount;
                    }
                    if (Master.UIMenu != null)
                    {
                        Master.UIMenu.myCamera.transform.localPosition = Random.insideUnitSphere * shakeAmount;
                    }
                    break;
                case 3:
                    Master.Background.myCamera.transform.localPosition = Random.insideUnitSphere * shakeAmount;
                    break;
                case 4:
